...
public class UserEndPoints {
	...
	static String json_schema_path = ".\\src\\test\\resources\\testData\\json_schema.json";
	static String faker_json_path = ".\\src\\test\\resources\\testData\\faker_json_schema.json";

	//method created for getting url's from properties file
	static ResourceBundle getURL()
	{
		ResourceBundle routes = ResourceBundle.getBundle("testData\\routes"); //load properties file
		return routes;
	}
